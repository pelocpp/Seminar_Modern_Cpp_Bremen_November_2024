...
namespace Exercises_MoveSemantics {
    ...
    namespace Exercise_01 {
        ...
        public:
            ...
            // Move-Konstruktor: Nur aus Wertzuweisungen
            Person(Person&& p) noexcept
            {
                std::println("Person (Person&& p): {}", p.m_name);
            ...
            {
                std::println("Person (const Person& p): {}", p.m_name);
                m_name = p.m_name;
                m_values = p.m_values;
            }
        ...
        static void testExercise_01() {

            {
                ...
                for (int i = 0; i < 100; ++i) {
                    ...
                    std::println("Index: {} - Size: {} - Capacity: {}",
                        i, persons.size(), persons.capacity());
                ...
                //Person dagobert{ "Dagobert Duck" };
                //Person daisy{ "Daisy Duck" };

                //persons.push_back( std::move(dagobert));
                //persons.push_back(std::move(daisy));
