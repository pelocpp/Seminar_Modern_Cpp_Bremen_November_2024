...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        //var n;
        //n.value = 123;
        //n.anotherValue = 123.54;

        auto z1 = 123.456;  // Type Deduction
                            // Typableitung
    ...
    //auto tueWas(bool flag, float f, double d)
    //{
    //    if (flag) {
    //        return (float) d;
    //    }
    ...
    //auto tueWas(bool flag, T f, U d) -> decltype ( f + d )
    //{
    //    if (flag) {
    //        return d;
    //    }
    ...
    void test_tueWas()
    {
        auto x = (short) 123 + (short) 456;

        // auto result = tueWas <float, double>  (false, 123.5f, 123.456);

        // AD    :  Argument Deduction // ab C++ 17 / 20
        auto result = tueWas<> (false, 123.345,  456.456);  // 
    }


    static double foo1(bool flag, float f, double d) {};

    static auto foo2(bool flag, float f, double d) -> double {}
    ...
    static void test_06() {
        ...
        decltype ( auto ) msg999 = getMessage();
