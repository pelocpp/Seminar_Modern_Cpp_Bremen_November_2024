...
namespace BraceInitialization {
    ...
    static void test_00()
    {
        ...
        double d21 = 123;   // Compiler konvertiert

        double d22 = ival;      // Compiles
    ...
    static void test_01()
    {
        ...
        int z2{ 123 };  //  Point p = new Point();

        Boint p{};    // Funktion p, keine Parameter, Objekt Boint als Ergebnis  
        p.print();
    ...
    static void test_05()
    {
        ...
        Class obj2(11, 12);  // obj.m_a => 11, obj.m_b => 12
    ...
    static void test_09()
    {
        ...
        // Alles ist NULL --- REP STOS Befehl
        int intArray11[100] = { 0 };

        // lauter 1-en
        int intArray12[100] = { 1 };

        // schlechteste Variante
        for (int i = 0; i < 100; ++i)  // Index-Fehler
            intArray12[i] = 1;

        // BESSER ALS JEDE For-Schleife !!!!!!!!!
        std::fill(
            std::begin(intArray12),
            std::end(intArray12),
            1
        );

        std::memset(intArray12, 1, sizeof (intArray12));
