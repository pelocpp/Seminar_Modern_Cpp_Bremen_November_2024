...
namespace Lambdas {
    ...
    static bool compare (int n1, int n2) {
        ...
        std::println("com. {} with {}", n1, n2);  // C++ 20/23
    ...
    public:
        ...
        bool operator() (int n1, int n2) const {
            ...
            std::println("operator() - com. {} with {}", n1, n2);  // C++ 20/23
    ...
    static void test_03()
    {
       // void test_function() { }
        ...
        std::sort(
            ...
            vec.end(),
            [] (int n1, int n2)  {
                // std::println("Lambda - com. {0} with {1}", n1, n2);  // C++ 20/23
                return n1 < n2;
            }
        );
    ...
    static void test_07() {
        ...
        auto lambda = [ variable = 10 ] () mutable -> int {
           ...
           // int variable = 10;
            variable++;
            return variable;  // return type deduction
        };
    ...
    static void test_08() {
        ...
        //  Capture Clause, Zugriffsklausel, Erfassungsliste

        // Template Klasse // CTAD   / Class Template Argument Deduction Typableitung
